...
import razas.Guerreros;
import razas.Random;
import razas.Nortaichian;

public class NortaichianTest {

	private Guerreros nortaichian = new Nortaichian();
	private Guerreros random = new Random();
	...
	/*
	 * se comprueba que hace 18 de daño básico en su ataque
	 */
	@Test
	...
	public void prueba010() {
		...
		Assert.assertEquals(48, nortaichian.getSalud());
		Assert.assertEquals(82, random.getSalud());
